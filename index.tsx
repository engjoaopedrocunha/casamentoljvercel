...
import churchAsset from "@/assets/church.png.asset.json";
import sprigAsset from "@/assets/sprig.png.asset.json";
import monogramAsset from "@/assets/monogram.png.asset.json";
...
const weddingConfig = {
  ...
  church: {
    ...
    mapsLink: "https://maps.google.com/?q=Santuario+Eucaristico+Nossa+Senhora+do+Bom+Despacho",
  },
  ...
  reception: {
    ...
    address: "[EDITAR ENDEREÇO]",
    time: "21:00",
    mapsLink: "https://maps.google.com/?q=Buffet+Sonia+Bittencourt",
  },
    ...
    <main className="min-h-screen overflow-x-hidden bg-ivory font-serif text-deep">
      ...
      <section className="relative flex min-h-screen flex-col items-center justify-center px-6 pt-24 pb-16 text-center">
        ...
        <Reveal className="relative" delay={100}>
          <Monogram className="w-[48px] sm:w-[58px]" />
        </Reveal>
        ...
        <Reveal delay={700} className="relative mt-10">
          <h1 className="font-script mx-auto max-w-[16ch] text-[2.4rem] leading-[1.18] text-deep sm:text-[3.6rem]">
            {weddingConfig.bride}
        ...
        <Reveal>
          <div className="mx-auto flex max-w-xl items-center justify-center gap-6 sm:gap-12">
            ...
            <div className="flex flex-col items-center">
              ...
              <span className="my-1 text-7xl leading-none font-light text-deep sm:text-8xl">11</span>
      ...
      <footer className="px-6 py-32 text-center sm:py-40">
        <Reveal>
          ...
          <Monogram className="w-[42px] sm:w-[50px]" />
